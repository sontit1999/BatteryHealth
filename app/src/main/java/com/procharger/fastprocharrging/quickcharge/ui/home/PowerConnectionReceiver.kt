...
import com.procharger.fastprocharrging.quickcharge.data.interactor.BoInteractor
import com.procharger.fastprocharrging.quickcharge.ui.boconfirmation.OptimizationConfirmActivity
import com.procharger.fastprocharrging.quickcharge.ui.chargehistory.SharePreferenceUtils
        ...
        if (intent?.action == Intent.ACTION_POWER_CONNECTED) {
            ...
            ctx?.run {
                ...
                if (appSettingsModel.isExitAppWhenUnplugged) {
                    sendBroadcast(Intent(com.procharger.fastprocharrging.quickcharge.common.Constants.ACTION_EXIT_APP))
                }
