package com.procharger.fastprocharrging.quickcharge.ui.boresult
...
//        private const val RC_DRAW_OVERLAY = 257
    ...
    private fun parseIntent(intent: Intent?) {
        shouldCheckShowingRateDialog =
            intent?.extras?.getBoolean(com.procharger.fastprocharrging.quickcharge.common.Constants.KEY_CHECK_SHOWING_RATE_DIALOG) ?: false
    }
