...
import com.sh.entertainment.fastcharge.common.extension.sharedPref
import com.sh.entertainment.fastcharge.common.extension.toast
...
object CommonUtil {
    ...
    fun openAppInPlayStore(ctx: Context) {
        ...
        if (intent.resolveActivity(ctx.packageManager) != null) {
            ...
            openBrowser(ctx, com.sh.entertainment.fastcharge.common.Constants.LINK_APP_ON_STORE)
        }
    }
